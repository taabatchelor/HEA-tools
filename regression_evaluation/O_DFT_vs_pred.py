...
csvTrainDFT = '../3_DFT_histogram/O_train.csv'
csvTestDFT = '../3_DFT_histogram/O_test.csv'
csvTrainPred = 'O_train_pred.csv'
csvTestPred = 'O_test_pred.csv'
...
majorTick, minorTick, tickFormat = 0.5, 0.1, '%.1f'
...
# save image
plt.savefig('O_DFT_vs_pred.png', dpi=300)